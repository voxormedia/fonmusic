...
const T = {
  ru: {
    ...
    pricing_label: "ТАРИФЫ", pricing_h: "Прозрачные цены",
    plans: [
      { name: "Базовый", price: "499 000", desc: "Для небольших заведений", popular: "", features: ["Веб-плеер в браузере", "30 000+ треков", "Готовые станции", "Без рекламы", "Официальный сертификат"], highlight: false },
      { name: "Стандарт", price: "699 000", desc: "Для кафе, ресторанов и магазинов", popular: "Самый популярный", features: ["Всё из Базового", "Автоматическое расписание", "Удалённое управление", "FonMusic Box в комплекте", "Музыка 24/7"], highlight: true },
  ...
  uz: {
    ...
    pricing_label: "TARIFLAR", pricing_h: "Shaffof narxlar",
    plans: [
      { name: "Asosiy", price: "499 000", desc: "Kichik muassasalar uchun", popular: "", features: ["Brauzerda veb-pleer", "30 000+ trek", "Tayyor stansiyalar", "Reklamasiz", "Rasmiy sertifikat"], highlight: false },
      { name: "Standart", price: "699 000", desc: "Kafe, restoran va do'konlar uchun", popular: "Eng mashhur", features: ["Asosiydan hammasi", "Avtomatik jadval", "Masofaviy boshqaruv", "FonMusic Box komplektda", "24/7 musiqa"], highlight: true },
      { name: "Premium", price: "999 000", desc: "Muassasalar tarmog'i uchun", popular: "", features: ["Standartdan hammasi", "Bir necha muassasa", "Har bir nuqtada atmosfera", "Markazlashgan boshqaruv", "Ustuvor yordam"], highlight: false },
    ],
