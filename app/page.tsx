...
const T = {
  ru: {
    ...
    plans: [
      ...
      { name: "Премиум", price: "899 000", desc: "Для сетей заведений", popular: "", features: ["Всё из Стандарта", "Несколько заведений", "Разные атмосферы в точках", "Централизованное управление", "Приоритетная поддержка"], highlight: false },
    ],
    ...
    box_price: "500 000 сум при оплате за 3 месяца · бесплатно: Базовый 12 мес. · Стандарт 9 мес. · Премиум 6 мес.", box_btn: "Заказать Box →",
  ...
  uz: {
    ...
    plans: [
      ...
      { name: "Premium", price: "899 000", desc: "Muassasalar tarmog'i uchun", popular: "", features: ["Standartdan hammasi", "Bir necha muassasa", "Har bir nuqtada atmosfera", "Markazlashgan boshqaruv", "Ustuvor yordam"], highlight: false },
    ],
    ...
    box_price: "3 oy to'lovda 500 000 so'm · bepul: Asosiy 12 oy · Standart 9 oy · Premium 6 oy", box_btn: "Box buyurtma qilish →",
