...
const T = {
  ru: {
    ...
    badge: "♪ ЛИЦЕНЗИРОВАННАЯ МУЗЫКА ДЛЯ БИЗНЕСА — ОТ 499 000 СУМ В МЕСЯЦ",
    ...
    box_free: "бесплатно",
    box_free_cond: "при оплате за 3 месяца",
    extra_label: "Дополнительные заведения",
    extra_price: "599 000 сум / мес за каждое",
    extra_calc: ["2 точки — 1 598 000 сум", "3 точки — 2 197 000 сум", "5 точек — 3 395 000 сум"],
    ...
    box_free2: "или бесплатно при оплате подписки за 3 месяца",
    ...
    plans: [
      { key: "basic", name: "Базовый", price: "499 000", desc: "Для одного небольшого заведения", popular: false, features: ["1 точка", "Все музыкальные атмосферы", "Веб-плеер", "Ручное переключение музыки"], missing: ["Автоматическое расписание"], ctaHref: "/signup", accent: "#8BA7BE", box: false },
      { key: "standard", name: "Стандарт", price: "699 000", desc: "Оптимальный тариф для кафе, магазинов, салонов и фитнес-клубов", popular: true, features: ["1 точка", "Все музыкальные атмосферы", "Веб-плеер", "Автоматическое расписание музыки", "Удалённое управление"], missing: [], ctaHref: "/signup?plan=standard", accent: "#C9A84C", box: true },
      { key: "premium", name: "Премиум", price: "999 000", desc: "Для сетей кафе, ресторанов, магазинов, фитнес-клубов и салонов красоты", popular: false, features: ["1 точка включена", "Все функции тарифа Стандарт", "Централизованное управление сетью", "Приоритетная поддержка"], missing: [], ctaHref: "/signup?plan=premium", accent: "#A78BFA", box: true },
    ],
    compare: [
  ...
  uz: {
    ...
    badge: "♪ BIZNES UCHUN LITSENZIYALANGAN MUSIQA — OYIGA 499 000 SO'MDAN",
    ...
    box_free: "bepul",
    box_free_cond: "3 oylik to'lovda",
    extra_label: "Qo'shimcha muassasalar",
    extra_price: "599 000 so'm / oy har biri uchun",
    extra_calc: ["2 nuqta — 1 598 000 so'm", "3 nuqta — 2 197 000 so'm", "5 nuqta — 3 395 000 so'm"],
    ...
    box_free2: "yoki 3 oylik obunada bepul",
    ...
    plans: [
      { key: "basic", name: "Asosiy", price: "499 000", desc: "Bitta kichik muassasa uchun", popular: false, features: ["1 nuqta", "Barcha musiqa atmosferalari", "Veb-pleer", "Musiqani qo'lda almashtirish"], missing: ["Avtomatik jadval"], ctaHref: "/signup", accent: "#8BA7BE", box: false },
      { key: "standard", name: "Standart", price: "699 000", desc: "Kafe, do'kon, salon va fitnes-klublar uchun optimal tarif", popular: true, features: ["1 nuqta", "Barcha musiqa atmosferalari", "Veb-pleer", "Avtomatik musiqa jadvali", "Masofaviy boshqaruv"], missing: [], ctaHref: "/signup?plan=standard", accent: "#C9A84C", box: true },
      { key: "premium", name: "Premium", price: "999 000", desc: "Kafe, restoran, do'kon, fitnes-klub va salonlar tarmog'i uchun", popular: false, features: ["1 nuqta kiritilgan", "Standart tarifning barcha funksiyalari", "Tarmoqni markazlashgan boshqaruv", "Ustuvor yordam"], missing: [], ctaHref: "/signup?plan=premium", accent: "#A78BFA", box: true },
    ],
    compare: [
